...
namespace AuthCX.Services.TextProcessing
{
    class StopwordRemovalService : IStopwordRemovalService
    {
        /// <summary>
        /// Words we want to remove.
        /// </summary>
        private readonly Dictionary<string, bool> _stops = new Dictionary<string, bool>
        {
            {"a", true},
            {"about", true},
            {"above", true},
